...
If run against the provided LocalTest and AzureLabTest (or any typical CRN test harness), the Node implementation should successfully store and retrieve data, handle address keys, and pass the major functionality tests.
